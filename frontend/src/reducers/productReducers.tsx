import { product, productDetails, productList } from "../actions/interfaces/product";
...
export const productListReducer = (state: product = { products: []}, action:productList) => {
  switch (action.type) {
...
export const productDetailsReducer = (state = { product:{reviews:[]} } , action:productDetails) => {
  switch (action.type) {
